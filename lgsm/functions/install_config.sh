...
fn_fetch_default_config(){
	...
	echo -e "================================="
	echo -e "default configs from https://github.com/Shark-vil/Game-Server-Configs"
	fn_sleep_time
	mkdir -p "${lgsmdir}/config-default/config-game"
	githuburl="https://raw.githubusercontent.com/Shark-vil/Game-Server-Configs/master"
